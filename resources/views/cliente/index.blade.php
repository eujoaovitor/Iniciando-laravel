...
<head>
    ...
    <title>Painel de Controle joaovitor.com.br - Bootstrap v5.3</title>
                        ...
                        <tbody>
                            ...
                            @forelse ($cliente as $clienteSite)
                                <tr>
                                    ...
                                    <td><a href="{{ route('cliente.editar', ['cliente' => $clienteSite->id]) }}"
                                            class="btn btn-primary">Editar</a></td>
                                    <td>
                                        <form action="{{ route('cliente.delete', ['cliente' => $clienteSite->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
