...
<body class="bg-body-tertiary">
    ...
    <div class="container">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome"
                                    placeholder="Seu Nome Completo" value="{{ old('nome', $cliente->nome) }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="cpf" name="cpf"
                                    placeholder="Seu CPF" value="{{ old('cpf', $cliente->cpf) }}">
                                <div class="invalid-feedback">
                                    CPF obrigatório
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="fone" name="fone"
                                    placeholder="Celular (41) 7777-7777" value="{{ old('fone', $cliente->fone) }}">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control" id="nascimento" name="nascimento"
                                    placeholder="Data de nascimento" value="{{ old('nascimento', $cliente->nascimento) }}">
                                <div class="invalid-feedback">
        ...
        <footer class="my-5 pt-5 text-body-secondary text-center text-small">
            <p class="mb-1">&copy; joavitor.com.br</p>
